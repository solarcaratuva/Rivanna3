    ...
    interaction8Counter(0)
{
    ...
    textArea2_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_B8Q5));
    add(textArea2_1);

    textArea2_1_1.setXY(582, 82);
    textArea2_1_1.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    textArea2_1_1.setLinespacing(0);
    textArea2_1_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_8MDQ));
    add(textArea2_1_1);
    ...
    textArea2_1_1_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_IAXF));
    add(textArea2_1_1_1);
    ...
    textArea2_1_1_1_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_TOY6));
    add(textArea2_1_1_1_1);

    textArea2.setXY(698, 153);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    textArea2.setLinespacing(0);
    textArea2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_4C7R));
    add(textArea2);
    ...
    textArea3.setTypedText(touchgfx::TypedText(T___SINGLEUSE_IYL2));
    add(textArea3);

    textArea5.setXY(14, 262);
    textArea5.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea5.setLinespacing(0);
    textArea5.setTypedText(touchgfx::TypedText(T___SINGLEUSE_8451));
    add(textArea5);

    textArea4.setXY(106, 262);
    textArea4.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea4.setLinespacing(0);
    textArea4.setWildcard(touchgfx::TypedText(T___SINGLEUSE_FG9P).getText());
    textArea4.resizeToCurrentText();
    textArea4.setTypedText(touchgfx::TypedText(T___SINGLEUSE_RRP5));
    add(textArea4);
}
...
void Screen1ViewBase::handleTickEvent()
{
    ...
    if(frameCountInteraction12Interval == TICK_INTERACTION12_INTERVAL)
    {
        ...
        //Set textArea3 wildcard to __SingleUse_D97Z
        textArea3.setWildcard(touchgfx::TypedText(T___SINGLEUSE_D97Z).getText());
