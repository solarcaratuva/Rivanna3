...
void send_DashboardCommands_CAN_message(bool cruise_en, bool cruise_inc, bool cruise_dec){ 
    ...
    wheel_can_struct.cruise_en = cruise_en;
...
void edge_handler(void){
    queue.call(send_DashboardCommands_CAN_message, false, false, false);
}

void cruise_control_enable_rise() {
    queue.call(send_DashboardCommands_CAN_message, true, false, false);
}

void cruise_control_increase_rise() {
    queue.call(send_DashboardCommands_CAN_message, false, true, false);
}

void cruise_control_decrease_rise() {
    queue.call(send_DashboardCommands_CAN_message, false, false, true);
}
...
int main() {
    ...
    cruise_control_enable.rise(cruise_control_enable_rise);
